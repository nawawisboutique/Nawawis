    ...
    return(
        <MainLayout>
            <div div className="bg-fuchsia-100 p-6 mt-3 text-xs">
                <h2 className="font-semibold mb-2 my-5 mx-6 sm:text-2xl font-['serif']" align='center'>Bank BRI</h2>
                <h2 className="font-normal mb-2 my-5 mx-6 sm:text-2xl font-['serif']" align='center'> No : 614301019224536  a/n TUTUT IRYANA DEVI </h2>
